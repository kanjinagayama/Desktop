function sendGlobalRowDataToDb(globalRowAttrToSet,askGlobalRowName){
  jQuery.ajax({
      ...
      method: 'post',
      data:{  globalRowAttributestoSend:globalRowAttrToSet, globalRowTitle: askGlobalRowName },
...
function subscribeFormWidgetRender(this_widget_subscribeForm){
            ...
            var this_widget_form_inputSubmit = "<input type='submit' value='"+formBtnText+"'  style='"+inputButtonStyles+"' disabled>";
...
function countDownWidgetRender(this_widget_countdown){
  ...
  var countDownScript = " <script> jQuery('#"+countDownId+"').countdown('"+pbCountDownDate+"', function(event) { jQuery(this).html(event.strftime('' +'<div style=\"width: 100%; letter-spacing:5px; \"><div style=\"display: inline-block; width: 25%;\"><p style=\" font-size:"+pbCountDownTextSize+"px; color:"+pbCountDownColor+"; line-height:0; \" > %D </p> <p style=\" font-size:"+pbCountDownLabelTextSize+"px; color:"+pbCountDownLabelColor+"; display:"+pbCountDownLabel+"; line-height:0; \">DAYS</p></div><div style=\"display: inline-block; width: 25%;\"><p style=\" font-size:"+pbCountDownTextSize+"px; color:"+pbCountDownColor+"; line-height:0; \"> %H </p> <p style=\" font-size:"+pbCountDownLabelTextSize+"px; color:"+pbCountDownLabelColor+"; display:"+pbCountDownLabel+"; line-height:0; \">HOURS</p></div><div style=\"display: inline-block; width: 25%;\"><p style=\" font-size:"+pbCountDownTextSize+"px; color:"+pbCountDownColor+"; line-height:0; \"> %M </p> <p style=\" font-size:"+pbCountDownLabelTextSize+"px; color:"+pbCountDownLabelColor+"; display:"+pbCountDownLabel+"; line-height:0; \">MINUTES</p></div><div style=\"display: inline-block; width: 25%;\"><p style=\" font-size:"+pbCountDownTextSize+"px; color:"+pbCountDownColor+"; line-height:0; \"> %S </p> <p style=\" font-size:"+pbCountDownLabelTextSize+"px; color:"+pbCountDownLabelColor+"; display:"+pbCountDownLabel+"; line-height:0; \">SECONDS</p></div> </div>' )); });  </script> ";

  var countDownContainer = "<div id="+countDownId+" class='popb_countDown' style='text-align:center; padding:2% 3%;'></div>";

  return countDownScript + countDownContainer;
...
function navigationMenuWidgetRender(this_column_menu_content){
  ...
  this_widget_nav_shortcode = "[pb_samlple_nav pb_menu='"+menuName+"'    pb_logo_url='"+logoURL+"' menucolor='"+menuColor+"'  menu_class='"+menuStyle+"' menu_font='"+pbMenuFontFamily.replace(/\+/g, ' ')+"' ]";
...
function iconListWidgetRender(this_widget_icon_list){
  ...
  iconListTextFontFam  = '';
  if (typeof(this_widget_icon_list['iconListTextFontFamily']) != 'undefined') {
    iconListTextFontFam = this_widget_icon_list['iconListTextFontFamily'];
    iconListTextFontFamily = this_widget_icon_list['iconListTextFontFamily'].replace(/\+/g, ' ');
  }
  ...
  return pbIconListItemContainer + pbIconListUniqueStyles;
}

function formBuilderWidgetRender(this_widget_form_builder){
