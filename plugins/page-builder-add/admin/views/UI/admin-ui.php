...
<script type="text/javascript">
  ...
  jQuery('.insertTemplateFormSubmit').on('click', function(e)  {
    ...
    var confirmIt =  confirm('Are you sure ? It will replace your existing template.');
    if (confirmIt == true) {
        ...
        jQuery.ajax({
            ...
            success: function(result){
                if (result == 'updated'){
                  ...
                  jQuery('.upt_response').html('There is some bug which is preventing this page to be updated, Contact the <a href="https://wordpress.org/support/plugin/page-builder-add" traget="_blank" > Bug Killers </a>')
                }
            }
        });
