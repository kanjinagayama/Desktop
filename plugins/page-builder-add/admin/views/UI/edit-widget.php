          ...
          <div id="tabBasicWidgetOptions" class="tab active" style="min-height:400px;">
            <div class="wdt-left" style="width: 100% !important;">
              ...
              <div class="pbp-widgets wdt-menu" style="display:none">
                <div class="pbp_form" style=" background: #fff; padding:20px 10px 20px 25px; width: 99%;">
                  <label for="ftr-menu-style-1" style="width: 90%;" > Style 1 <img src="<?php echo ULPB_PLUGIN_URL.'/images/menu/menu-style-1.png'; ?>" class='menu-select'> </label>
                  <input type="radio" style="width: 15px;" class="ftr-menu-style" id='ftr-menu-style-1' name="ftr-menu-select-style" value='menu-style-1'>
                  <br><br><hr><br><br>
                  <label for="ftr-menu-style-2" style="width: 90%;" > Style 2 (Sticky) <img src="<?php echo ULPB_PLUGIN_URL.'/images/menu/menu-style-2.png'; ?>" class='menu-select'> </label>
                  <input type="radio" style="width: 15px;" class="ftr-menu-style" id='ftr-menu-style-2' name="ftr-menu-select-style" value='menu-style-2'>
                  <br><br><hr><br><br>
                  <label for="ftr-menu-style-4" style="width: 90%;" > Style 3 <img src="<?php echo ULPB_PLUGIN_URL.'/images/menu/menu-style-4.png'; ?>" class='menu-select'> </label>
                  <input type="radio" style="width: 15px;" class="ftr-menu-style" id='ftr-menu-style-4' name="ftr-menu-select-style" value='menu-style-4'>
                  <br><br><hr><br><br>
                  <label for="ftr-menu-style-3" style="width: 99%;" > Style 4 (Without Logo) <img src="<?php echo ULPB_PLUGIN_URL.'/images/menu/menu-style-3.png'; ?>" class='menu-select'> </label>
              ...
              <div class="pbp-widgets wdt-btn-gen" style="display:none; ">
                <div id="btn-gen" class="pbp_form" style="margin:11px 0 0 0; background: #fff; padding:20px 10px 20px 25px; width: 99%;">
                  ...
                  <div>
                    ...
                    <div class="responsiveOps responsiveOptionsContainterLarge">
                      <label></label>
                      <input type="number" class="btnWidthPercent">%
                    </div>
                    <div class="responsiveOps responsiveOptionsContainterMedium" style="display: none;">
                        <label></label>
                        <input type="number" class="btnWidthPercentTablet">%
                    </div>
                    <div class="responsiveOps responsiveOptionsContainterSmall" style="display: none;">
                      <label></label>
                      <input type="number" class="btnWidthPercentMobile">%
                    </div>
                  </div>
                  <br><br><hr><br>
