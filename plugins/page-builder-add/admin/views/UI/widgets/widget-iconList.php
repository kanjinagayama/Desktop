...
<div class="tab-content" style="box-shadow:none;">
	...
	<div id="iconList_cf2" class="tab">
        ...
        <input type="number" class="iconListIconSize">
        <br><br><hr><br>
        ...
        <input type="number" class="iconListTextSize"> 
        <br><br><hr><br> 
        <label>Text Indent: </label>   
        <input type="number" class="iconListTextIndent"> 
        <br><br><hr><br>   
    ...
    (function($){
        ...
        $(document).on( 'change','.iconListItemText', function(){
            if ($(this).val() == '') {
                ...
                $(this).parent().siblings('.handleHeader').html($(this).val() + '<span class="dashicons dashicons-trash slideRemoveButton" style="float: right;"></span>');
                jQuery('.closeWidgetPopup').click();
            }
        });
