<?php if ( ! defined( 'ABSPATH' ) ) exit; 
  ...
  echo $psScripts.'<div id="PbPostSlider-'.$PSrandID.'" class="pbOwl-carousel" style="background:'.''.'; text-align:'.$psTextAlignment.'; width:95%; margin: 0 auto; padding:0.1% 0 2% 0;">';
  ...
  $PSliderReadMore = '<a  style="display:'.$psReadMore.';"> '.$psMoreLinkText.' </a>';
 ...
 ob_end_clean();
  ...
  $('#PbPostSlider-$PSrandID').owlCarousel({
    items:1,
    singleItem: true,
    autoPlay : $psAutoplay,
    stopOnHover : true,
