  ...
  $colWidgets = $currentColumn['colWidgets'];
      ...
      for ($j = 0; $j < count($colWidgets); $j++) {  // widgets loop
          ...
          switch ($this_column_type) {
            ...
            break;
              ...
              if (isset($this_widget_btn_content['btnWidthPercent'])) {
                ...
                if ($btnWidthPercent !== '') {
                  $POPB_buton_width = "padding: $btnHeight"."px 5"."px !important; width:$btnWidthPercent"."%;";
                }
              }else{
                $btnWidthPercent = '';
              }
              ...
              $this_widget_btn = "<style> .btn-$randomBtnClass:hover{ background-color: $btnHoverBgColor !important; background: $btnHoverBgColor !important;} </style><br>
                ...
                if (isset($this_widget_btn_content['btnFontSizeTablet'])) {
                  ...
                  $thisButtonWidgetResponsiveWidgetStylesTablet = "
                    #widget-$j-$Columni-".$row["rowID"]."  .btn-$randomBtnClass {
                     ...
                     width: ".$this_widget_btn_content['btnWidthPercentTablet']."% !important;
                  ...
                  $thisButtonWidgetResponsiveWidgetStylesMobile = "
                    #widget-$j-$Columni-".$row["rowID"]."  .btn-$randomBtnClass {
                     ...
                     width: ".$this_widget_btn_content['btnWidthPercentMobile']."% !important;
              ...
              case 'wigt-pb-form':
               ...
               echo $this_widget_form = "<form id='ulpb_form".$pbFormID."' action='".$SfactionURL."' method='post'> ".$this_widget_form_inputID.$this_widget_form_inputName." ".$this_widget_form_inputEmail." ".wp_nonce_field('POPB_send_Subsform_data','POPB_SubsForm_Nonce')." ".$this_widget_form_inputSubmit."<p id='response'></p> </form>
            ...
            case 'wigt-pb-countdown':
              ...
              if ($widgetCountDownLoadScripts == true) {
                ...
                $pbCountDownLibrary = " <script src='".ULPB_PLUGIN_URL."/js/countdown.js'></script> ";
              }
         ...
         /// $columnContentOld = 
          ...
          $columnContent = $columnContent."\n"."<div class='widget-$j $menuSpecificClass $widgetCustomClass'  id='widget-$j-$Columni-".$row["rowID"]."'  style='$widgetMarigns $menuSpecificStyles  $widgetStyling' >".$widgetContent."</div>";
