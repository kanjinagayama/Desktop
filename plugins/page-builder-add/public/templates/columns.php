...
for($i = 1; $i <= $columns; $i++) {
      ...
      include('widgets.php');
        ...
        if ($columnWidth == 0 || $columnWidth === "") {
          ...
          //$columnWidthPercent = ($columnWidth/1268)*100;
          $colHeight = '10';
      $columnStyles =  "#".$row["rowID"]."-$Columni {"."width:".$columnWidthPercent.$columnWidthUnit."; min-height:$rowHeight"."px; $colBackgroundOptions background-color:$columnBgColor; $columnMarginStyle  $columnPaddingStyle  $this_col_border_shadow  $columnCSS }";
