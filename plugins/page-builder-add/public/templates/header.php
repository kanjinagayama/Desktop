...
if (isset($data['pageOptions']['pagePaddingTablet'])) {
  ...
  $pagePaddingMobile = $data['pageOptions']['pagePaddingMobile'];
          ...
          $POPBPagePaddingResponsiveTablet = "\n".
            ...
            '.ulpb_PageBody body { padding-top:'.$pagePaddingTablet['pagePaddingTopTablet'].'%; padding-bottom:'.$pagePaddingTablet['pagePaddingBottomTablet'].'%; padding-left:'.$pagePaddingTablet['pagePaddingLeftTablet'].'%; padding-right:'.$pagePaddingTablet['pagePaddingRightTablet'].'%;  }  '.
            ' ';

          $POPBPagePaddingResponsiveMobile = "\n".

            '.ulpb_PageBody body { padding-top:'.$pagePaddingMobile['pagePaddingTopMobile'].'%; padding-bottom:'.$pagePaddingMobile['pagePaddingBottomMobile'].'%; padding-left:'.$pagePaddingMobile['pagePaddingLeftMobile'].'%; padding-right:'.$pagePaddingMobile['pagePaddingRightMobile'].'%;  }  '.
            ' ';
...
<script type="text/javascript" src="<?php echo ULPB_PLUGIN_URL.'/js/jquery.min.js'; ?>"></script>
        ...
        if ($pagePaddingRight != '0' && $pagePaddingLeft != '0') {
          ...
          ?>
            @media screen and (max-width: 1310px) {
              .ulpb_PageBody {padding-left: 3% !important; padding-right: 3% !important; }
            }
        <?php
          }
        }
...
<?php
        ...
        if ($POPBDefaultsEnable == 'true') {
          ...
          $POPBGlobalStylesTag = "\n".
            ...
            '.ulpb_PageBody h1 { font-family:'.str_replace('+',' ',$POPB_typefaces['typefaceHOne']).'; font-size:'.$POPB_typeSizes['typeSizeHOne'].'px; }  '.

            '.ulpb_PageBody h2 { font-family:'.str_replace('+',' ',$POPB_typefaces['typefaceHTwo']).'; font-size:'.$POPB_typeSizes['typeSizeHTwo'].'px; }  '.

            '.ulpb_PageBody p { font-family:'.str_replace('+',' ',$POPB_typefaces['typefaceParagraph']).'; font-size:'.$POPB_typeSizes['typeSizeParagraph'].'px; }  '.

            '.ulpb_PageBody button { font-family:'.str_replace('+',' ',$POPB_typefaces['typefaceButton']).'; font-size:'.$POPB_typeSizes['typeSizeButton'].'px; }  '.
            
            '.ulpb_PageBody a { font-family:'.str_replace('+',' ',$POPB_typefaces['typefaceAnchorLink']).'; font-size:'.$POPB_typeSizes['typeSizeAnchorLink'].'px; } ';
          ...
          if (isset($POPB_typeSizes['typeSizeHOneTablet'])) {
            ...
            $POPBGlobalStylesResponsiveTablet = "\n".
              ...
              '.ulpb_PageBody h1 { font-size:'.$POPB_typeSizes['typeSizeHOneTablet'].'px !important; }  '.

              '.ulpb_PageBody h2 { font-size:'.$POPB_typeSizes['typeSizeHTwoTablet'].'px !important; }  '.

              '.ulpb_PageBody p { font-size:'.$POPB_typeSizes['typeSizeParagraphTablet'].'px !important; }  '.

              '.ulpb_PageBody button { font-size:'.$POPB_typeSizes['typeSizeButtonTablet'].'px !important; }  '.
              
              '.ulpb_PageBody a {  font-size:'.$POPB_typeSizes['typeSizeAnchorLinkTablet'].'px !important; } '.
              ' ';

            $POPBGlobalStylesResponsiveMobile = "\n".

              '.ulpb_PageBody h1 { font-size:'.$POPB_typeSizes['typeSizeHOneMobile'].'px !important; }  '.

              '.ulpb_PageBody h2 { font-size:'.$POPB_typeSizes['typeSizeHTwoMobile'].'px !important; }  '.

              '.ulpb_PageBody p { font-size:'.$POPB_typeSizes['typeSizeParagraphMobile'].'px !important; }  '.

              '.ulpb_PageBody button { font-size:'.$POPB_typeSizes['typeSizeButtonMobile'].'px !important; }  '.
              
              '.ulpb_PageBody a {  font-size:'.$POPB_typeSizes['typeSizeAnchorLinkMobile'].'px !important; } '.
              ' ';
