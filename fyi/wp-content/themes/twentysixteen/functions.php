...
function customize_cookie_timeout($timeout) {
return time() + DAY_IN_SECONDS * 31;
}
add_filter('post_password_expires','customize_cookie_timeout');

function change_category_dropdown_title($cat_args){
  $cat_args['show_option_none'] = 'キーワードを選択';
  return $cat_args;
}
